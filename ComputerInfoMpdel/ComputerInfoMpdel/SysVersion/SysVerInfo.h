...
public:
	...
	void GetServicePackInfo1(TCHAR* szServicePack) const;	// additional information about service pack
	void GetServiceInfoPack(TCHAR* szServicePack);
